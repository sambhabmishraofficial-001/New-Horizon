...
| | | |
|--|--|--|
| **Atrium** | Institute home | Critical path, discovery feed, twins on duty, invariant watch |
...
© New Horizon · Atrium build 0.9.0. This is a reference UI; behaviour is deliberately fictive to showcase positioning, interaction model, and feel.
